...
\paragraph{Server (S):} L'entità Server è incaricata di conservare tutte le preferenze degli utenti sul referendum, e di contare i voti per determinare il risultato finale.\\
...
L'attore è anche incaricato di registrare correttamente i voti e di garantire che non vengano registrati voti non validati, in questo senso che non passano i processi di verifica previsti dal protocollo.\\
